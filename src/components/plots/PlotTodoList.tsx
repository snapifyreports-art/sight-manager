    ...
    <div className={cn("rounded border p-2 text-sm", isOverdue && "border-red-200 bg-red-50/30")}>
      ...
      <div className="mt-1.5 flex flex-wrap items-center gap-1 border-t pt-1.5">
        ...
        {isPending ? (
          ...
          <>
            {variant === "start" ? (
              <Button size="sm" variant="outline" className="h-9 gap-1 border-green-200 px-2 text-xs text-green-700 hover:bg-green-50"
                onClick={() => onAction(job.id, "start")}>
                <Play className="size-2.5" /> Start
              </Button>
            ) : (
              <Button size="sm" variant="outline" className="h-9 gap-1 border-blue-200 px-2 text-xs text-blue-700 hover:bg-blue-50"
            ...
            <Button size="sm" variant="outline" className="h-9 gap-1 border-emerald-200 px-2 text-xs text-emerald-700 hover:bg-emerald-50"
              onClick={() => onPullForward(job)}
              title="Shift start earlier">
              Pull
            </Button>
            <Button size="sm" variant="outline" className="h-9 gap-1 border-red-200 px-2 text-xs text-red-700 hover:bg-red-50"
              onClick={() => onDelay(job)}
    ...
    <div className={cn("rounded border p-2 text-sm", variant === "delivery" && "border-amber-100 bg-amber-50/30")}>
      ...
      <div className="mt-1.5 flex flex-wrap items-center gap-1 border-t pt-1.5">
        ...
        {isPending ? (
          ...
          <>
            {hasEmail && (
              <Button size="sm" variant="outline" className="h-9 gap-1 border-violet-200 px-2 text-xs text-violet-700 hover:bg-violet-50"
