...
export async function GET(req: NextRequest) {
  ...
  for (const site of sites) {
    ...
    // pushes. This was the one cron missing it.
    try {
      ...
      // Keep the loop alive, but never silently — ops needs the why.
      console.error(`[inspection-alerts] site ${site.id} failed:`, err);
      summary.failed++;
    }
  }
